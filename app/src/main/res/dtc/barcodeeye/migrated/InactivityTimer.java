...
package dtc.barcodeeye.migrated;
...
public final class InactivityTimer {
    ...
    private static final String TAG = fr.nuitdelinfo.dtc.barcodeeye.migrated.InactivityTimer.class.getSimpleName();
    ...
    private final class PowerStatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Intent.ACTION_BATTERY_CHANGED.equals(intent.getAction())) {
                ...
                if (onBatteryNow) {
                    fr.nuitdelinfo.dtc.barcodeeye.migrated.InactivityTimer.this.onActivity();
                } else {
                    fr.nuitdelinfo.dtc.barcodeeye.migrated.InactivityTimer.this.cancel();
                }
            }
        }
    }
