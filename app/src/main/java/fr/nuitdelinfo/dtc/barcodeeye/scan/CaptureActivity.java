...
package fr.nuitdelinfo.dtc.barcodeeye.scan;
...
import fr.nuitdelinfo.dtc.agedeglass.fr.nuitdelinfo.dtc.agedeglass.recovocale.VoiceActivity;
...
public final class CaptureActivity extends BaseGlassActivity implements
        ...
        if (fromLiveScan) {
           ...
           acquisitionResult.getChars(0, 1, slash, 0);
            ...
            if(slash!= null && slash.length > 0 && slash[0]=='/')
            {
                ...
                Log.d("jg",acquisitionResult);
                String[] formatedPatientsData = acquisitionResult.split("/");
                WebService.ajouterPatient(formatedPatientsData[1],
                formatedPatientsData[2],
                formatedPatientsData[3],
                formatedPatientsData[4],
                Integer.parseInt(formatedPatientsData[5]),
                        Integer.parseInt(formatedPatientsData[6]));


                Intent inent = new Intent(this.getApplicationContext(), VoiceActivity.class);
                inent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                this.getApplicationContext().startActivity(inent);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            if (mHandler == null) {
                mHandler = new CaptureActivityHandler(this, null, mDecodeHints, null, mCameraManager);
            }
